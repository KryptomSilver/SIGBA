    ...
    <div class="tabla-lg">
        <div class="container">
            ...
            <div class="secciones">
                <!-- datos generales-->
                <?php
                $idfam = $_GET['idfamilia'];
                include('procesos/conexion.php');
                $sql = "SELECT * FROM familias where id = $idfam";
                ...
                <div class="hide" id="tab2">
                    <div class="tabla-lg">
                        <div class="row">
                            <div class="col-9"></div>
                            <div class="col-3">
                                <button class="btn btn-md btn-primary" onclick="verificar(2);">Agregar</button>
                            </div>
                        </div>
                ...
                <div class="hide" id="tab3">
                    ...
                    <form action="" id="vivienda_update">
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    <?php
                                include('procesos/conexion.php');
                                $sql = "select sum(becas) as becas,sum(adultos) as adultos,sum(otros) as otros,sum(pension) as pension from integrantes WHERE fk_familia = $idfam";
                                $resultado = mysqli_query($conn,$sql);
