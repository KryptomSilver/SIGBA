...
<body>
    ...
    <div class="tabla-lg">
        ...
        <form id="proveedores_update" method="post">
            <input type="hidden" id="id" value="<?php echo $rows['idpersona'];?>">
            <input type="hidden" id="proveedor" value="1">
            <div class="row">
                <div class="col-8">
                    <div class="form-group">
                        <label class="">Razon social:</label>
                        <input class="form-control" value="<?php echo $rows['razon_Social'];?>" id="razon" type="text"
                            required>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="numext" value="<?php echo $rows['num_Exterior'];?>" class="form-control"
                            required>
                ...
                <div class="col-2">
                    <div class="form-group">
                        ...
                        <input type="text" id="codpostal" pattern="[0-9]{5}" title="Introduzca un codigo postal valido"
                            value="<?php echo $rows['codPostal'];?>" class="form-control " required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $rows['colonia'];?>" id="colonia" class="form-control"
                            required>
                    </div>
                </div>
                <div class="col-6">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="telefono" value="<?php echo $rows['telefono'];?>" class="form-control"
                            required>
                    </div>
                </div>
                <div class="col-4">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="email" id="correo" value="<?php echo $rows['correo'];?>" class="form-control"
                            required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-4"></div>
                <div class="col-3">
                    <a href="proveedores.php" class="btn btn-lg btn-primary" title="Ir la página anterior">Cancelar</a>
                </div>
                <div class="col-2"></div>
                <div class="col-3">
