                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $rfc; ?>"name="rfc" pattern = "^([A-ZÑ\x26]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1]))([A-Z\d]{3})?$" title = "introduzca un RFC valido" class="form-control"required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="celular" pattern="[0-9]{10}" title="Introduzca un telefono valido" class="form-control"required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
